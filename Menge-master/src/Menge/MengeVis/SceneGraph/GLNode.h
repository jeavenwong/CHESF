...
namespace MengeVis {
	...
	namespace SceneGraph {
		...
		public:
			...
			virtual void drawGLOgre(bool select = false) = 0;
			//	virtual void drawGLO( float& x1, float& x2, float& x3, bool select=false );
			...
			std::vector<float> x; //用于显示ground  3个数一组 -x;z;y, 
			int agentID;
		...
		public:
			 ...
			 *						If this node has no parent matrix, the identity matrix is
			 *						stored.
			 */
