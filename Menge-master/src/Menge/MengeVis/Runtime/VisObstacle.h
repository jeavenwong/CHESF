...
namespace MengeVis {
	namespace Runtime {
		...
		public:
			...
			void drawGLOgre(bool select = false);
		protected:
			/*!
		...
		class MENGEVIS_API VisSpecialArea : public SceneGraph::GLNode {
		public:
			/*!
			*	@brief		Constructor.
			*
			...
			*	@param		p1		The second end point of the line segment.
			*/
			VisSpecialArea(const std::vector<Menge::Math::Vector2> vertexs);
		...
		protected:
			...
			*/
			...
			std::vector<Menge::Math::Vector2> _vertexs;
		...
		class MENGEVIS_API VisGround : public SceneGraph::GLNode {
		public:
			/*!
			*	@brief		Constructor.
			*
			...
			*	@param		p1		The second end point of the line segment.
			*/
			VisGround(std::vector<Menge::Math::Vector3> &p, int count);
		...
		protected:
			...
			*	@brief		The line segment's first end point.
			*/
			//const	Menge::Math::Vector3 *_p;
			std::vector<Menge::Math::Vector3> _p;
			int _count;
