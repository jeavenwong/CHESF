...
/*!
 *	@file		GoalSelectorGroupFactor.h
 *	@brief		The definition of the nearest goal selector. 
 */

#ifndef __GOAL_SELECTOR_GroupFactor_H__
#define __GOAL_SELECTOR_GroupFactor_H__
...
namespace Menge {
	...
	namespace BFSM {
		 ...
		 */
		class MENGE_API GroupFactorGoalSelector : public SetGoalSelector {
		public:
			/*!
		 ...
		 */
		class MENGE_API GroupFactorGoalSelectorFactory : public SetGoalSelectorFactory { 
		public:
			/*!
			 ...
			 */
			virtual const char * name() const { return "groupfactor"; }
		...
		protected:
			 ...
			 */
			GoalSelector * instance() const { return new GroupFactorGoalSelector(); }	
		};
	}	// namespace BFSM
}	// namespace Menge
