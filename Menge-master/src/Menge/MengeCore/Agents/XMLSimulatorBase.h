...
namespace Menge {
	...
	namespace Agents {
		...
		public:
			...
			virtual void setGlobalPlan(GlobalPlan * globalPlan) = 0;
			virtual void setTacticalPlan(TacticalPlan * tacticalPlan) = 0;
			virtual void addEnvironmentalChange(EnvironmentalChange * eChange) = 0;
			virtual void setOperationPlan(OperationPlan * operationPlan) = 0;
			/*!
			...
			virtual bool hasGlobalPlan() const = 0;
			virtual bool hasTacticalPlan() const = 0;
			virtual bool hasOperationPlan() const = 0;
			/*!
			...
			std::vector<Agents::Map *>  getMaps() { return _maps; }

			void addMap(Agents::Map *map) {
				_maps.push_back(map);
			}
		protected:
			/*!
