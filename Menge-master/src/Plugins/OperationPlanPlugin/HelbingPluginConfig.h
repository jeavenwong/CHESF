...
#ifndef __OperationPlanPlugin_CONFIG_H__
#define __OperationPlanPlugin_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined(OperationPlanPlugin_STATICLIB )
    #define OperationPlanPlugin_API
  #else
    #if defined( OperationPlanPlugin_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define OperationPlanPlugin_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define OperationPlanPlugin_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #else
    #if defined( OperationPlanPlugin_EXPORT )
      #define OperationPlanPlugin_API __attribute__ ((visibility ("default")))
    #else
