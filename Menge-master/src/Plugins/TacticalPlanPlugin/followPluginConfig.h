...
/*!
 *	@file		HelbingConfig.h
 *	@brief		Configures the shared library aspect of the includes.
 */

#ifndef __TacticalPlanFollowPlugin_CONFIG_H__
#define __TacticalPlanFollowPlugin_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined(TacticalPlanFollowPlugin_STATICLIB )
    #define TacticalPlanFollowPlugin_API
  #else
    #if defined( TacticalPlanFollowPlugin_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define TacticalPlanFollowPlugin_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define TacticalPlanFollowPlugin_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #else
    #if defined( TacticalPlanFollowPlugin_EXPORT )
      #define TacticalPlanFollowPlugin_API __attribute__ ((visibility ("default")))
    #else
