...
#ifndef __NewObstacleChangePlugin_CONFIG_H__
#define __NewObstacleChangePlugin_CONFIG_H__
...
#if defined( NewObstacleChange_STATICLIB )
#define NewObstacleChange_API
  #else
#if defined( NewObstacleChange_EXPORT )
      // We are building the DLL, export the symbols tagged like this
#define NewObstacleChange_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
#define NewObstacleChange_API  __declspec(dllimport)
    #endif
  #endif
...
#define NewObstacleChange_API
  #else
#if defined( NewObstacleChange_EXPORT )
#define NewObstacleChange_API __attribute__ ((visibility ("default")))
    #else
