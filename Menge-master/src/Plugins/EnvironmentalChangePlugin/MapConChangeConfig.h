...
#ifndef __MapConChange_CONFIG_H__
#define __MapConChange_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined( MapConChange_STATICLIB )
    #define MapConChange_API
  #else
    #if defined( MapConChange_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define MapConChange_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define MapConChange_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #else
    #if defined( MapConChange_EXPORT )
      #define MapConChange_API __attribute__ ((visibility ("default")))
    #else
