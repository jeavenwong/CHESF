...
#ifndef __DijkstraGlobalPlanPlug_CONFIG_H__
#define __DijkstraGlobalPlanPlug_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined(DijkstraGlobalPlanPlug_STATICLIB )
    #define DijkstraGlobalPlanPlug_API
  #else
    #if defined( DijkstraGlobalPlanPlug_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define DijkstraGlobalPlanPlug_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define DijkstraGlobalPlanPlug_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #else
    #if defined( DijkstraGlobalPlanPlug_EXPORT )
      #define DijkstraGlobalPlanPlug_API __attribute__ ((visibility ("default")))
    #else
