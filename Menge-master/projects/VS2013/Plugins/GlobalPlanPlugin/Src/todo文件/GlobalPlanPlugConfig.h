...
#ifndef __GlobalPlanPlug_CONFIG_H__
#define __GlobalPlanPlug_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined(GlobalPlanPlug_STATICLIB )
    #define DijkstraGlobalPlanPlug_API
  #else
    #if defined(GlobalPlanPlug_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define GlobalPlanPlug_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define GlobalPlanPlug_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #if defined( GlobalPlanPlug_STATICLIB )
    #defineGlobalPlanPlug_API
  #else
    #if defined( GlobalPlanPlug_EXPORT )
      #define GlobalPlanPlug_API __attribute__ ((visibility ("default")))
    #else
