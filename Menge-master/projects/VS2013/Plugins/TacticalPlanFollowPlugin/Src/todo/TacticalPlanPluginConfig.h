...
#ifndef __TacticalPlanPlugin_CONFIG_H__
#define __TacticalPlanPlugin_CONFIG_H__
...
// Now set up compiler-dependent export/import symbols
  ...
  #if defined(TacticalPlanPlugin_STATICLIB )
    #define TacticalPlanFollowPlugin_API
  #else
    #if defined( TacticalPlanPlugin_EXPORT )
      // We are building the DLL, export the symbols tagged like this
      #define TacticalPlanPlugin_API  __declspec(dllexport)
    #else
      // If we are consuming the DLL, import the symbols tagged like this
      #define TacticalPlanPlugin_API  __declspec(dllimport)
    #endif
  #endif
  ...
  #if defined( TacticalPlanPlugin_STATICLIB )
    #define TacticalPlanPlugin_API
  #else
    #if defined( TacticalPlanPlugin_EXPORT )
      #define TacticalPlanPlugin_API __attribute__ ((visibility ("default")))
    #else
